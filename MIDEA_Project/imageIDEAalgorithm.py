...
if __name__ == '__main__':
  ...
  #open image to be encrypted
  with open("colorr.jpeg","rb") as imageFile:
       str = base64.b64encode(imageFile.read())
      
  print("Plaintext : " )
  hh=str  #raw_input("Enter the plaintext (length : 8) : ")
  key=key1.encode('hex')
  ...
  #opening decrypted image
  with open("colorr1.jpeg", "wb") as fh:
    fh.write(plaintext2.decode('base64'))
  sleep(5) 
  clear() 
  img=Image.open('colorr1.jpeg')
